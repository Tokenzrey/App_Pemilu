...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0025R.styleable.ActionBar);
        this.mBackground = obtainStyledAttributes.getDrawable(C0025R.styleable.ActionBar_background);
        this.mStackedBackground = obtainStyledAttributes.getDrawable(C0025R.styleable.ActionBar_backgroundStacked);
        this.mHeight = obtainStyledAttributes.getDimensionPixelSize(C0025R.styleable.ActionBar_height, -1);
        boolean z = true;
        if (getId() == C0025R.C0028id.split_action_bar) {
            this.mIsSplit = true;
            this.mSplitBackground = obtainStyledAttributes.getDrawable(C0025R.styleable.ActionBar_backgroundSplit);
        }
    ...
    public void onFinishInflate() {
        ...
        this.mActionBarView = findViewById(C0025R.C0028id.action_bar);
        this.mContextView = findViewById(C0025R.C0028id.action_context_bar);
    }
