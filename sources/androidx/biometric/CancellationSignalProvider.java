...
class CancellationSignalProvider {
    ...
    private androidx.core.p003os.CancellationSignal mFingerprintCancellationSignal;
    ...
    interface Injector {
        ...
        androidx.core.p003os.CancellationSignal getFingerprintCancellationSignal();
    }
    ...
    public CancellationSignalProvider() {
        this.mInjector = new Injector() { // from class: androidx.biometric.CancellationSignalProvider.1
            ...
            @Override // androidx.biometric.CancellationSignalProvider.Injector
            public androidx.core.p003os.CancellationSignal getFingerprintCancellationSignal() {
                return new androidx.core.p003os.CancellationSignal();
            }
        };
    }
    ...
    public void cancel() {
        ...
        androidx.core.p003os.CancellationSignal cancellationSignal2 = this.mFingerprintCancellationSignal;
