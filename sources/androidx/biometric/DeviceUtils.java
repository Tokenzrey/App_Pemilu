...
class DeviceUtils {
    ...
    public static boolean shouldUseFingerprintForCrypto(Context context, String str, String str2) {
        ...
        return isVendorInList(context, str, C0142R.array.crypto_fingerprint_fallback_vendors) || isModelInPrefixList(context, str2, C0142R.array.crypto_fingerprint_fallback_prefixes);
    }
    ...
    public static boolean shouldHideFingerprintDialog(Context context, String str) {
        ...
        return isModelInPrefixList(context, str, C0142R.array.hide_fingerprint_instantly_prefixes);
    }
    ...
    public static boolean shouldDelayShowingPrompt(Context context, String str) {
        ...
        return isModelInList(context, str, C0142R.array.delay_showing_prompt_models);
    }
    ...
    public static boolean canAssumeStrongBiometrics(Context context, String str) {
        ...
        return isModelInList(context, str, C0142R.array.assume_strong_biometrics_models);
    }
