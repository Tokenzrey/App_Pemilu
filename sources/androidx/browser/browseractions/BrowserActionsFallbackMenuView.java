...
import androidx.browser.C0149R;
...
public class BrowserActionsFallbackMenuView extends LinearLayout {
    ...
    public BrowserActionsFallbackMenuView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mBrowserActionsMenuMinPaddingPx = getResources().getDimensionPixelOffset(C0149R.dimen.browser_actions_context_menu_min_padding);
        this.mBrowserActionsMenuMaxWidthPx = getResources().getDimensionPixelOffset(C0149R.dimen.browser_actions_context_menu_max_width);
    }
