...
import androidx.appcompat.C0025R;
import androidx.constraintlayout.motion.widget.Debug;
import androidx.constraintlayout.motion.widget.FloatLayout;
import androidx.constraintlayout.widget.C0231R;
...
public class MotionLabel extends View implements FloatLayout {
    ...
    private void setUpTheme(Context context, AttributeSet attrs) {
        ...
        context.getTheme().resolveAttribute(C0025R.attr.colorPrimary, typedValue, true);
        TextPaint textPaint = this.mPaint;
