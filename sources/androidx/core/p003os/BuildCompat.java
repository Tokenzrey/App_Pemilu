...
public class BuildCompat {
    ...
    static {
        R_EXTENSION_INT = Build.VERSION.SDK_INT >= 30 ? Extensions30Impl.f82R : 0;
        S_EXTENSION_INT = Build.VERSION.SDK_INT >= 30 ? Extensions30Impl.f83S : 0;
    ...
    private static final class Extensions30Impl {
        ...
        /* renamed from: R */
        static final int f82R = SdkExtensions.getExtensionVersion(30);

        /* renamed from: S */
        static final int f83S = SdkExtensions.getExtensionVersion(31);
