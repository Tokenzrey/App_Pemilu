...
public enum FieldType {
    ...
    FieldType(int i, Collection collection, JavaType javaType) {
        ...
        int i3 = C04111.$SwitchMap$com$google$protobuf$FieldType$Collection[collection.ordinal()];
        boolean z = true;
        if (i3 == 1) {
        ...
        this.primitiveScalar = (collection != Collection.SCALAR || (i2 = C04111.$SwitchMap$com$google$protobuf$JavaType[javaType.ordinal()]) == 1 || i2 == 2 || i2 == 3) ? false : false;
    }
