...
public class FlatBufferBuilder {
    ...
    public FlatBufferBuilder(int i, ByteBufferFactory byteBufferFactory, ByteBuffer byteBuffer, Utf8 utf8) {
        ...
        if (byteBuffer != null) {
            this.f123bb = byteBuffer;
            byteBuffer.clear();
            this.f123bb.order(ByteOrder.LITTLE_ENDIAN);
        } else {
            this.f123bb = byteBufferFactory.newByteBuffer(i);
        }
        this.utf8 = utf8;
        this.space = this.f123bb.capacity();
    }
    ...
    public int offset() {
        return this.f123bb.capacity() - this.space;
    }

    public void pad(int i) {
        for (int i2 = 0; i2 < i; i2++) {
            ByteBuffer byteBuffer = this.f123bb;
            int i3 = this.space - 1;
            this.space = i3;
    ...
    public ByteBuffer createUnintializedVector(int i, int i2, int i3) {
        ...
        ByteBuffer order = this.f123bb.slice().order(ByteOrder.LITTLE_ENDIAN);
        order.limit(i4);
        return order;
    }
    ...
    public int createString(CharSequence charSequence) {
        ...
        this.utf8.encodeUtf8(charSequence, this.f123bb);
        return endVector();
    }
    ...
    public int createString(ByteBuffer byteBuffer) {
        ...
        ByteBuffer byteBuffer2 = this.f123bb;
        int i = this.space - remaining;
        this.space = i;
        byteBuffer2.position(i);
        this.f123bb.put(byteBuffer);
        return endVector();
    }
    ...
    public int endTable() {
        ...
        loop2: while (true) {
            ...
            int capacity = this.f123bb.capacity() - this.vtables[i5];
            int i6 = this.space;
            short s = this.f123bb.getShort(capacity);
            if (s == this.f123bb.getShort(i6)) {
                for (int i7 = 2; i7 < s; i7 += 2) {
                    if (this.f123bb.getShort(capacity + i7) != this.f123bb.getShort(i6 + i7)) {
                        break;
                    }
                }
                i = this.vtables[i5];
        ...
        if (i != 0) {
            int capacity2 = this.f123bb.capacity() - offset;
            this.space = capacity2;
            this.f123bb.putInt(capacity2, i - offset);
        } else {
    ...
    public void required(int i, int i2) {
        int capacity = this.f123bb.capacity() - i;
        if (!(this.f123bb.getShort((capacity - this.f123bb.getInt(capacity)) + i2) != 0)) {
    ...
    protected void finish(int i, boolean z) {
        ...
        addOffset(i);
        if (z) {
            addInt(this.f123bb.capacity() - this.space);
        }
        this.f123bb.position(this.space);
        this.finished = true;
    }
    ...
    public byte[] sizedByteArray(int i, int i2) {
        ...
        this.f123bb.position(i);
        this.f123bb.get(bArr);
        return bArr;
    }

    public byte[] sizedByteArray() {
        return sizedByteArray(this.space, this.f123bb.capacity() - this.space);
    }

    public InputStream sizedInputStream() {
        finished();
        ByteBuffer duplicate = this.f123bb.duplicate();
        duplicate.position(this.space);
        duplicate.limit(this.f123bb.capacity());
