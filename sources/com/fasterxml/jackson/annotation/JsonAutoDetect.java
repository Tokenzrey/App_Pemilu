...
public @interface JsonAutoDetect {
    ...
    public enum Visibility {
        ...
        public boolean isVisible(Member member) {
            int i = C09381.f150x23d16a11[ordinal()];
            if (i != 1) {
                if (i == 3) {
    ...
    public static class Value implements JacksonAnnotationValue<JsonAutoDetect>, Serializable {
        ...
        public static Value construct(PropertyAccessor propertyAccessor, Visibility visibility) {
            ...
            int i = C09381.$SwitchMap$com$fasterxml$jackson$annotation$PropertyAccessor[propertyAccessor.ordinal()];
            if (i != 1) {
                if (i != 2) {
                    if (i == 3) {
    ...
    static /* synthetic */ class C09381 {
        ...
        static final /* synthetic */ int[] f150x23d16a11;
        ...
        static {
            ...
            try {
                f150x23d16a11[Visibility.NONE.ordinal()] = 2;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                f150x23d16a11[Visibility.NON_PRIVATE.ordinal()] = 3;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                f150x23d16a11[Visibility.PROTECTED_AND_PUBLIC.ordinal()] = 4;
            } catch (NoSuchFieldError unused11) {
            }
            try {
                f150x23d16a11[Visibility.PUBLIC_ONLY.ordinal()] = 5;
