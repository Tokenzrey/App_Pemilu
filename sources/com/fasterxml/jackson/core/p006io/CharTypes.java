...
public final class CharTypes {
    ...
    /* renamed from: HB */
    protected static final byte[] f153HB;
    protected static final byte[] HBlower;

    /* renamed from: HC */
    protected static final char[] f154HC;
    ...
    static {
        ...
        f153HB = new byte[length];
        HBlower = new byte[length];
        for (int i = 0; i < length; i++) {
            f153HB[i] = (byte) f154HC[i];
    ...
    public static char[] copyHexChars(boolean z) {
        return (char[]) (z ? f154HC.clone() : HClower.clone());
    }
    ...
    public static byte[] copyHexBytes(boolean z) {
        return (byte[]) (z ? f153HB.clone() : HBlower.clone());
    }
