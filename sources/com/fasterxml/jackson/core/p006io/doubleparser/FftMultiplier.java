...
/* renamed from: com.fasterxml.jackson.core.io.doubleparser.FftMultiplier */
...
class FftMultiplier {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: com.fasterxml.jackson.core.io.doubleparser.FftMultiplier$ComplexVector */
    /* loaded from: classes.dex */
    public static final class ComplexVector {
        ...
        void addInto(int i, ComplexVector complexVector, int i2, MutableComplex mutableComplex) {
            mutableComplex.real = this.f160a[realIdx(i)] + complexVector.real(i2);
            mutableComplex.imag = this.f160a[imagIdx(i)] + complexVector.imag(i2);
        }

        void addTimesIInto(int i, ComplexVector complexVector, int i2, MutableComplex mutableComplex) {
            mutableComplex.real = this.f160a[realIdx(i)] - complexVector.imag(i2);
            mutableComplex.imag = this.f160a[imagIdx(i)] + complexVector.real(i2);
        }

        void applyInverseWeights(ComplexVector complexVector) {
            int i = this.offset;
            int i2 = complexVector.offset;
            double[] dArr = complexVector.f160a;
            for (int i3 = 0; i3 < this.length; i3++) {
                ...
                this.f160a[i4] = FastDoubleSwar.fma(-d, dArr[i6], dArr[i5] * d2);
                i += 2;
                i2 += 2;
            }
        }
        ...
        void copyInto(int i, MutableComplex mutableComplex) {
            mutableComplex.real = this.f160a[realIdx(i)];
            mutableComplex.imag = this.f160a[imagIdx(i)];
        }

        double imag(int i) {
            return this.f160a[(i << 1) + this.offset + 1];
        }

        void imag(int i, double d) {
            this.f160a[(i << 1) + this.offset + 1] = d;
        }
        ...
        void multiply(int i, MutableComplex mutableComplex) {
            ...
            this.f160a[imagIdx] = FastDoubleSwar.fma(d, mutableComplex.imag, d2 * mutableComplex.real);
        }
        ...
        void multiplyByIAnd(int i, MutableComplex mutableComplex) {
            ...
            this.f160a[imagIdx] = FastDoubleSwar.fma(d, mutableComplex.real, mutableComplex.imag * d2);
        }
        ...
        void multiplyConjugate(int i, MutableComplex mutableComplex) {
            ...
            this.f160a[imagIdx] = FastDoubleSwar.fma(-d, mutableComplex.imag, mutableComplex.real * d2);
        }

        void multiplyConjugateInto(int i, MutableComplex mutableComplex, MutableComplex mutableComplex2) {
            double d = this.f160a[realIdx(i)];
            double d2 = this.f160a[imagIdx(i)];
        ...
        void multiplyConjugateTimesI(int i, MutableComplex mutableComplex) {
            ...
            this.f160a[imagIdx] = FastDoubleSwar.fma(d3, mutableComplex.real, (-d2) * mutableComplex.imag);
        }
        ...
        void multiplyPointwise(ComplexVector complexVector) {
            ...
            while (i2 < i3) {
                ...
                this.f160a[i5] = FastDoubleSwar.fma(d, d4, d2 * d3);
                i += 2;
                i2 += 2;
            }
        }
        ...
        double part(int i, int i2) {
            return this.f160a[(i << 1) + i2];
        }

        double real(int i) {
            return this.f160a[(i << 1) + this.offset];
        }

        void real(int i, double d) {
            this.f160a[(i << 1) + this.offset] = d;
        }
        ...
        void timesTwoToThe(int i, int i2) {
            ...
            this.f160a[imagIdx] = Math.scalb(d2, i2);
        }
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: com.fasterxml.jackson.core.io.doubleparser.FftMultiplier$MutableComplex */
    /* loaded from: classes.dex */
