...
/* renamed from: com.fasterxml.jackson.core.io.schubfach.FloatToDecimal */
...
public final class FloatToDecimal {
    ...
    /* renamed from: W */
    private static final int f166W = 8;
    ...
    private int toDecimal(int i, int i2, int i3) {
        ...
        long m494g1 = 1 + MathUtils.m494g1(flog10threeQuartersPow2);
        int rop = rop(m494g1, j2 << flog2pow10);
        int rop2 = rop(m494g1, j << flog2pow10);
        int rop3 = rop(m494g1, j3 << flog2pow10);
        int i5 = rop >> 2;
        if (i5 >= 100) {
