...
public class ShapePath {
    ...
    public void lineTo(float f, float f2) {
        ...
        pathLineOperation.f248x = f;
        pathLineOperation.f249y = f2;
    ...
    public void lineTo(float f, float f2, float f3, float f4) {
        ...
        pathLineOperation2.f248x = f3;
        pathLineOperation2.f249y = f4;
    ...
    public static class LineShadowOperation extends ShadowCompatOperation {
        ...
        public void draw(Matrix matrix, ShadowRenderer shadowRenderer, int i, Canvas canvas) {
            RectF rectF = new RectF(0.0f, 0.0f, (float) Math.hypot(this.operation.f249y - this.startY, this.operation.f248x - this.startX), 0.0f);
        ...
        float getAngle() {
            return (float) Math.toDegrees(Math.atan((this.operation.f249y - this.startY) / (this.operation.f248x - this.startX)));
        }
    }
    ...
    static class InnerCornerShadowOperation extends ShadowCompatOperation {
        ...
        public void draw(Matrix matrix, ShadowRenderer shadowRenderer, int i, Canvas canvas) {
            ...
            double hypot = Math.hypot(this.operation1.f248x - this.startX, this.operation1.f249y - this.startY);
            double hypot2 = Math.hypot(this.operation2.f248x - this.operation1.f248x, this.operation2.f249y - this.operation1.f249y);
            ...
            this.renderMatrix.set(matrix);
            this.renderMatrix.preTranslate(this.operation1.f248x, this.operation1.f249y);
            this.renderMatrix.preRotate(getStartAngle());
        ...
        float getStartAngle() {
            return (float) Math.toDegrees(Math.atan((this.operation1.f249y - this.startY) / (this.operation1.f248x - this.startX)));
        }

        float getEndAngle() {
            return (float) Math.toDegrees(Math.atan((this.operation2.f249y - this.operation1.f249y) / (this.operation2.f248x - this.operation1.f248x)));
        }
    ...
    public static class PathLineOperation extends PathOperation {
        ...
        public void applyToPath(Matrix matrix, Path path) {
            ...
            path.lineTo(this.f248x, this.f249y);
