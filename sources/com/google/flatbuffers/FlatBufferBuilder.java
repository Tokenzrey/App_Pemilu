...
public class FlatBufferBuilder {
    ...
    public FlatBufferBuilder(int i, ByteBufferFactory byteBufferFactory, ByteBuffer byteBuffer, Utf8 utf8) {
        ...
        if (byteBuffer != null) {
            this.f272bb = byteBuffer;
            byteBuffer.clear();
            this.f272bb.order(ByteOrder.LITTLE_ENDIAN);
        } else {
            this.f272bb = byteBufferFactory.newByteBuffer(i);
        }
        this.utf8 = utf8;
        this.space = this.f272bb.capacity();
    }
    ...
    public int offset() {
        return this.f272bb.capacity() - this.space;
    }

    public void pad(int i) {
        for (int i2 = 0; i2 < i; i2++) {
            ByteBuffer byteBuffer = this.f272bb;
            int i3 = this.space - 1;
            this.space = i3;
    ...
    public ByteBuffer createUnintializedVector(int i, int i2, int i3) {
        ...
        ByteBuffer order = this.f272bb.slice().order(ByteOrder.LITTLE_ENDIAN);
        order.limit(i4);
        return order;
    }
    ...
    public int createString(CharSequence charSequence) {
        ...
        this.utf8.encodeUtf8(charSequence, this.f272bb);
        return endVector();
    }
    ...
    public int createString(ByteBuffer byteBuffer) {
        ...
        ByteBuffer byteBuffer2 = this.f272bb;
        int i = this.space - remaining;
        this.space = i;
        byteBuffer2.position(i);
        this.f272bb.put(byteBuffer);
        return endVector();
    }
    ...
    public int endTable() {
        ...
        loop2: while (true) {
            ...
            int capacity = this.f272bb.capacity() - this.vtables[i5];
            int i6 = this.space;
            short s = this.f272bb.getShort(capacity);
            if (s == this.f272bb.getShort(i6)) {
                for (int i7 = 2; i7 < s; i7 += 2) {
                    if (this.f272bb.getShort(capacity + i7) != this.f272bb.getShort(i6 + i7)) {
                        break;
                    }
                }
                i = this.vtables[i5];
        ...
        if (i != 0) {
            int capacity2 = this.f272bb.capacity() - offset;
            this.space = capacity2;
            this.f272bb.putInt(capacity2, i - offset);
        } else {
    ...
    public void required(int i, int i2) {
        int capacity = this.f272bb.capacity() - i;
        if (!(this.f272bb.getShort((capacity - this.f272bb.getInt(capacity)) + i2) != 0)) {
    ...
    protected void finish(int i, boolean z) {
        ...
        addOffset(i);
        if (z) {
            addInt(this.f272bb.capacity() - this.space);
        }
        this.f272bb.position(this.space);
        this.finished = true;
    }
    ...
    public byte[] sizedByteArray(int i, int i2) {
        ...
        this.f272bb.position(i);
        this.f272bb.get(bArr);
        return bArr;
    }

    public byte[] sizedByteArray() {
        return sizedByteArray(this.space, this.f272bb.capacity() - this.space);
    }

    public InputStream sizedInputStream() {
        finished();
        ByteBuffer duplicate = this.f272bb.duplicate();
        duplicate.position(this.space);
        duplicate.limit(this.f272bb.capacity());
