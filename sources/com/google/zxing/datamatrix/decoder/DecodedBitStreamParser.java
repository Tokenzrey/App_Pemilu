...
final class DecodedBitStreamParser {
    ...
    public static DecoderResult decode(byte[] bArr) throws FormatException {
        ...
        do {
            if (mode == Mode.ASCII_ENCODE) {
                ...
                int i = C16211.f283xb73eb560[mode.ordinal()];
                if (i == 1) {
    ...
    static /* synthetic */ class C16211 {
        ...
        static {
            ...
            try {
                f283xb73eb560[Mode.TEXT_ENCODE.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f283xb73eb560[Mode.ANSIX12_ENCODE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f283xb73eb560[Mode.EDIFACT_ENCODE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f283xb73eb560[Mode.BASE256_ENCODE.ordinal()] = 5;
