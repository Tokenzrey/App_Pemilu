...
import com.labters.documentscanner.C1642R;
...
public class PolygonView extends FrameLayout {
    ...
    private void initPaint() {
        ...
        this.paint = paint;
        paint.setColor(getResources().getColor(C1642R.C1643color.blue));
    ...
    private ImageView getImageView(int i, int i2) {
        ...
        imageView.setImageResource(C1642R.C1644drawable.circle);
        imageView.setX(i);
        imageView.setY(i2);
        ...
        public boolean onTouch(View view, MotionEvent motionEvent) {
            ...
            if (action == 0) {
                ...
                if (polygonView.isValidShape(polygonView.getPoints())) {
                    color = PolygonView.this.getResources().getColor(C1642R.C1643color.blue);
                } else {
                    color = PolygonView.this.getResources().getColor(C1642R.C1643color.orange);
                }
