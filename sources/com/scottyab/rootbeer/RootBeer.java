...
public class RootBeer {
    ...
    public boolean checkForBinary(String str) {
        ...
        for (String str2 : Const.getPaths()) {
            ...
            if (new File(str2, str).exists()) {
                QLog.m319v(str3 + " binary detected!");
                z = true;
            }
        }
        return z;
    ...
    private boolean isAnyPackageFromListInstalled(List<String> list) {
        ...
        for (String str : list) {
            try {
                ...
                QLog.m322e(str + " ROOT management app detected!");
                z = true;
    ...
    public boolean checkForRWPaths() {
        ...
        while (i2 < length) {
            ...
            if (split.length < 6) {
                QLog.m322e("Error formatting mount line: " + str);
            } else {
                String str2 = split[2];
                String str3 = split[5];
                    ...
                    if (str2.equalsIgnoreCase(str4)) {
                        ...
                        while (true) {
                            if (i4 >= length3) {
                                ...
                                QLog.m319v(str4 + " path is mounted with rw permissions! " + str);
                                z = true;
                                break;
                            } else {
                                i4++;
    ...
    public boolean checkForRootNative() {
        ...
        if (!canLoadNativeLibrary()) {
            QLog.m322e("We could not load the native library to test for root");
            return false;
        }
