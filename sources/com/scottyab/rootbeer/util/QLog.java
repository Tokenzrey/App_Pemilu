...
public final class QLog {
    ...
    /* renamed from: e */
    public static void m321e(Object obj, Throwable th) {
        if (isELoggable()) {
    ...
    /* renamed from: e */
    public static void m322e(Object obj) {
        if (isELoggable()) {
            Log.e(TAG, getTrace() + String.valueOf(obj));
            Log.e(TAG_GENERAL_OUTPUT, getTrace() + String.valueOf(obj));
        }
    ...
    /* renamed from: e */
    public static void m323e(Exception exc) {
        if (isELoggable()) {
            exc.printStackTrace();
        }
    }
    ...
    /* renamed from: w */
    public static void m317w(Object obj, Throwable th) {
        if (isWLoggable()) {
    ...
    /* renamed from: w */
    public static void m318w(Object obj) {
        if (isWLoggable()) {
            Log.w(TAG, getTrace() + String.valueOf(obj));
            Log.w(TAG_GENERAL_OUTPUT, getTrace() + String.valueOf(obj));
        }
    ...
    /* renamed from: i */
    public static void m320i(Object obj) {
        if (isILoggable()) {
    ...
    /* renamed from: d */
    public static void m324d(Object obj) {
        if (isDLoggable()) {
    ...
    /* renamed from: v */
    public static void m319v(Object obj) {
        if (isVLoggable()) {
