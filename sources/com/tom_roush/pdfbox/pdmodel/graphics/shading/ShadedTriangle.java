...
class ShadedTriangle {
    ...
    /* renamed from: v0 */
    private final double f490v0;

    /* renamed from: v1 */
    private final double f491v1;

    /* renamed from: v2 */
    private final double f492v2;
    ...
    public ShadedTriangle(PointF[] pointFArr, float[][] fArr) {
        ...
        this.f490v0 = edgeEquationValue(pointFArr[0], pointFArr[1], pointFArr[2]);
        this.f491v1 = edgeEquationValue(pointFArr[1], pointFArr[2], pointFArr[0]);
        this.f492v2 = edgeEquationValue(pointFArr[2], pointFArr[0], pointFArr[1]);
    }
    ...
    public boolean contains(PointF pointF) {
        ...
        if (i == 1) {
            ...
            if (edgeEquationValue(pointF, pointFArr[1], pointFArr[2]) * this.f490v0 < 0.0d) {
                return false;
            }
            PointF[] pointFArr2 = this.corner;
            if (edgeEquationValue(pointF, pointFArr2[2], pointFArr2[0]) * this.f491v1 < 0.0d) {
                return false;
            }
            PointF[] pointFArr3 = this.corner;
            return edgeEquationValue(pointF, pointFArr3[0], pointFArr3[1]) * this.f492v2 >= 0.0d;
        }
    }
