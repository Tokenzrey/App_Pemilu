...
public final class TextPosition {
    ...
    public TextPosition(int i, float f, float f2, Matrix matrix, float f3, float f4, float f5, float f6, float f7, String str, int[] iArr, PDFont pDFont, float f8, int i2) {
        ...
        this.fontSize = f8;
        this.fontSizePt = i2;
        this.f503x = getXRot(i);
        if (i == 0 || i == 180) {
            this.f504y = f2 - getYLowerLeftRot(i);
        } else {
            this.f504y = f - getYLowerLeftRot(i);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TextPosition) {
            ...
            if (Float.compare(textPosition.endX, this.endX) == 0 && Float.compare(textPosition.endY, this.endY) == 0 && Float.compare(textPosition.maxHeight, this.maxHeight) == 0 && this.rotation == textPosition.rotation && Float.compare(textPosition.f503x, this.f503x) == 0 && Float.compare(textPosition.f504y, this.f504y) == 0 && Float.compare(textPosition.pageHeight, this.pageHeight) == 0 && Float.compare(textPosition.pageWidth, this.pageWidth) == 0 && Float.compare(textPosition.widthOfSpace, this.widthOfSpace) == 0 && Float.compare(textPosition.fontSize, this.fontSize) == 0 && this.fontSizePt == textPosition.fontSizePt) {
    ...
    public int hashCode() {
        Matrix matrix = this.textMatrix;
        int hashCode = (((((((((((((((((((((matrix != null ? matrix.hashCode() : 0) * 31) + Float.floatToIntBits(this.endX)) * 31) + Float.floatToIntBits(this.endY)) * 31) + Float.floatToIntBits(this.maxHeight)) * 31) + this.rotation) * 31) + Float.floatToIntBits(this.f503x)) * 31) + Float.floatToIntBits(this.f504y)) * 31) + Float.floatToIntBits(this.pageHeight)) * 31) + Float.floatToIntBits(this.pageWidth)) * 31) + Float.floatToIntBits(this.widthOfSpace)) * 31) + Arrays.hashCode(this.charCodes)) * 31;
        PDFont pDFont = this.font;
