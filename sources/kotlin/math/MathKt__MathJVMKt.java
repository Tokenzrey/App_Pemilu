...
public class MathKt__MathJVMKt extends MathH {
    ...
    /* renamed from: ln */
    private static final double m277ln(double d) {
        return Math.log(d);
    }
    ...
    /* renamed from: ln */
    private static final float m276ln(float f) {
