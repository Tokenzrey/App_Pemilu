...
public final class MurmurHash3 {
    ...
    /* renamed from: C1 */
    private static final long f955C1 = -8663945395140668459L;
    private static final int C1_32 = -862048943;

    /* renamed from: C2 */
    private static final long f956C2 = 5545529020109919103L;
    ...
    /* renamed from: M */
    private static final int f957M = 5;
    private static final int M_32 = 5;

    /* renamed from: N1 */
    private static final int f958N1 = 1390208809;

    /* renamed from: N2 */
    private static final int f959N2 = 944331445;
    @Deprecated
    public static final long NULL_HASHCODE = 2862933555777941757L;
    private static final int N_32 = -430675100;

    /* renamed from: R1 */
    private static final int f960R1 = 31;
    private static final int R1_32 = 15;

    /* renamed from: R2 */
    private static final int f961R2 = 27;
    private static final int R2_32 = 13;

    /* renamed from: R3 */
    private static final int f962R3 = 33;
    ...
    public static long hash64(long j) {
        return fmix64(((Long.rotateLeft((Long.rotateLeft(Long.reverseBytes(j) * f955C1, 31) * f956C2) ^ 104729, 27) * 5) + 1390208809) ^ 8);
    }

    @Deprecated
    public static long hash64(int i) {
        return fmix64(((Long.rotateLeft((Integer.reverseBytes(i) & BodyPartID.bodyIdMax) * f955C1, 31) * f956C2) ^ 104729) ^ 4);
    }

    @Deprecated
    public static long hash64(short s) {
        return fmix64(((Long.rotateLeft(((((s & 255) << 8) ^ 0) ^ (255 & ((s & 65280) >> 8))) * f955C1, 31) * f956C2) ^ 104729) ^ 2);
    }
    ...
    public static long hash64(byte[] bArr, int i, int i2, int i3) {
        ...
        for (int i6 = 0; i6 < i5; i6++) {
            j = (Long.rotateLeft(j ^ (Long.rotateLeft(getLittleEndianLong(bArr, i + (i6 << 3)) * f955C1, 31) * f956C2), 27) * 5) + 1390208809;
        }
        long j2 = 0;
        switch ((i + i2) - (i + (i5 << 3))) {
            case 1:
                j ^= Long.rotateLeft(((bArr[i4] & 255) ^ j2) * f955C1, 31) * f956C2;
                break;
            case 2:
                j2 ^= (bArr[i4 + 1] & 255) << 8;
                j ^= Long.rotateLeft(((bArr[i4] & 255) ^ j2) * f955C1, 31) * f956C2;
    ...
    private static long[] hash128x64Internal(byte[] bArr, int i, int i2, long j) {
        ...
        while (i5 < i4) {
            ...
            long rotateLeft = ((Long.rotateLeft((Long.rotateLeft(littleEndianLong * f955C1, 31) * f956C2) ^ j9, 27) + j10) * 5) + 1390208809;
            j10 = ((Long.rotateLeft(j10 ^ (Long.rotateLeft(f956C2 * littleEndianLong2, 33) * f955C1), 31) + rotateLeft) * 5) + 944331445;
            i5++;
            j9 = rotateLeft;
            bArr2 = bArr;
        }
        ...
        switch ((i + i2) - (i + (i4 << 4))) {
            case 1:
                j2 = j9;
                j9 = j2 ^ (Long.rotateLeft((j11 ^ (bArr[i3] & UByte.MAX_VALUE)) * f955C1, 31) * f956C2);
                break;
            case 2:
                j2 = j9;
                j11 ^= (bArr[i3 + 1] & 255) << 8;
            ...
            case 9:
                j2 = j9;
                j3 = 0;
                j10 ^= Long.rotateLeft((j3 ^ (bArr[i3 + 8] & UByte.MAX_VALUE)) * f956C2, 33) * f955C1;
                j11 = 0 ^ ((bArr[i3 + 7] & 255) << 56);
                j11 ^= (bArr[i3 + 6] & 255) << 48;
                j11 ^= (bArr[i3 + 5] & 255) << 40;
                j11 ^= (bArr[i3 + 4] & 255) << 32;
