...
final class Dct {
    ...
    /* renamed from: A1 */
    private static final float f1013A1;

    /* renamed from: A2 */
    private static final float f1014A2;

    /* renamed from: A3 */
    private static final float f1015A3;

    /* renamed from: A4 */
    private static final float f1016A4;

    /* renamed from: A5 */
    private static final float f1017A5;

    /* renamed from: C2 */
    private static final float f1018C2;

    /* renamed from: C4 */
    private static final float f1019C4;

    /* renamed from: C6 */
    private static final float f1020C6;
    ...
    /* renamed from: Q */
    private static final float f1021Q;

    /* renamed from: R */
    private static final float f1022R;

    static {
        float cos = (float) Math.cos(0.7853981633974483d);
        f1013A1 = cos;
        f1014A2 = (float) (Math.cos(0.39269908169872414d) - Math.cos(1.1780972450961724d));
        f1015A3 = cos;
        f1016A4 = (float) (Math.cos(0.39269908169872414d) + Math.cos(1.1780972450961724d));
        f1017A5 = (float) Math.cos(1.1780972450961724d);
        float cos2 = (float) (Math.cos(0.39269908169872414d) * 2.0d);
        f1018C2 = cos2;
        f1019C4 = (float) (Math.cos(0.7853981633974483d) * 2.0d);
    ...
    public static void forwardDCT8(float[] fArr) {
        ...
        float f20 = f13 + f14;
        float f21 = f14 + f15;
        float f22 = ((f6 - f9) + f18) * f1013A1;
        float f23 = (f21 - f19) * f1017A5;
        float f24 = (f19 * f1014A2) - f23;
        float f25 = f20 * f1015A3;
        float f26 = (f21 * f1016A4) - f23;
        float f27 = f15 + f25;
        float f28 = f15 - f25;
        fArr[0] = f16 + f17;
        fArr[4] = f16 - f17;
    ...
    public static void forwardDCT8x8(float[] fArr) {
        ...
        for (int i10 = 0; i10 < 8; i10++) {
            ...
            float f48 = f41 + f42;
            float f49 = f42 + f43;
            float f50 = ((f34 - f37) + f46) * f1013A1;
            float f51 = (f49 - f47) * f1017A5;
            float f52 = (f47 * f1014A2) - f51;
            float f53 = f48 * f1015A3;
            float f54 = (f49 * f1016A4) - f51;
            float f55 = f43 + f53;
            float f56 = f43 - f53;
            fArr[i10] = f44 + f45;
            fArr[i17] = f44 - f45;
    ...
    public static void inverseDCT8(float[] fArr) {
        ...
        float f13 = f8 - f9;
        float f14 = f10 + f11;
        float f15 = f1020C6 * (f7 + f13);
        float f16 = (f1021Q * f7) + f15;
        float f17 = (f1022R * f13) - f15;
        float f18 = f1019C4;
        float f19 = f17 - f14;
    ...
    public static void inverseDCT8x8(float[] fArr) {
        ...
        for (int i10 = 0; i10 < 8; i10++) {
            ...
            float f44 = f39 - f40;
            float f45 = f41 + f42;
            float f46 = f1020C6 * (f38 + f44);
            float f47 = (f1021Q * f38) + f46;
            float f48 = (f1022R * f44) - f46;
            float f49 = f1019C4;
            float f50 = f34 * f49;
            float f51 = f48 - f45;
