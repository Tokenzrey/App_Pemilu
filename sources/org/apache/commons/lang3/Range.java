...
public class Range<T> implements Serializable {
    ...
    public static Range between(Comparable comparable, Comparable comparable2) {
        return m253of(comparable, comparable2, null);
    }
    ...
    /* renamed from: is */
    public static Range m256is(Comparable comparable) {
        return m253of(comparable, comparable, null);
    }

    /* renamed from: is */
    public static <T> Range<T> m255is(T t, Comparator<T> comparator) {
        return m253of(t, t, comparator);
    }

    /* JADX WARN: Incorrect types in method signature: <T::Ljava/lang/Comparable<-TT;>;>(TT;TT;)Lorg/apache/commons/lang3/Range<TT;>; */
    /* renamed from: of */
    public static Range m254of(Comparable comparable, Comparable comparable2) {
        return m253of(comparable, comparable2, null);
    }

    /* renamed from: of */
    public static <T> Range<T> m253of(T t, T t2, Comparator<T> comparator) {
        return new Range<>(t, t2, comparator);
    }
    ...
    public Range<T> intersectionWith(Range<T> range) {
        ...
        return m253of(getComparator().compare(this.minimum, range.minimum) < 0 ? range.minimum : this.minimum, getComparator().compare(this.maximum, range.maximum) < 0 ? this.maximum : range.maximum, getComparator());
    }
