...
public class ImmutableTriple<L, M, R> extends Triple<L, M, R> {
    ...
    /* renamed from: of */
    public static <L, M, R> ImmutableTriple<L, M, R> m225of(L l, M m, R r) {
    ...
    public static <L, M, R> ImmutableTriple<L, M, R> ofNonNull(L l, M m, R r) {
        return m225of(Objects.requireNonNull(l, "left"), Objects.requireNonNull(m, "middle"), Objects.requireNonNull(r, "right"));
    }
