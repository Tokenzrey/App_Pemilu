...
public class ASN1OutputStream {
    ...
    /* renamed from: os */
    private OutputStream f1092os;

    /* JADX INFO: Access modifiers changed from: package-private */
    public ASN1OutputStream(OutputStream outputStream) {
        this.f1092os = outputStream;
    }
    ...
    public static ASN1OutputStream create(OutputStream outputStream, String str) {
        return str.equals(ASN1Encoding.DER) ? new DEROutputStream(outputStream) : str.equals(ASN1Encoding.f1091DL) ? new DLOutputStream(outputStream) : new ASN1OutputStream(outputStream);
    }
    ...
    public DEROutputStream getDERSubStream() {
        return new DEROutputStream(this.f1092os);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public DLOutputStream getDLSubStream() {
        return new DLOutputStream(this.f1092os);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public final void write(int i) throws IOException {
        this.f1092os.write(i);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public final void write(byte[] bArr, int i, int i2) throws IOException {
        this.f1092os.write(bArr, i, i2);
    }
