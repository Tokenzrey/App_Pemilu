...
public class Haraka512Digest extends HarakaBase {
    ...
    private int haraka512256(byte[] bArr, byte[] bArr2, int i) {
        ...
        bArr3[0] = aesEnc(bArr3[0], f1278RC[0]);
        bArr3[1] = aesEnc(bArr3[1], f1278RC[1]);
        bArr3[2] = aesEnc(bArr3[2], f1278RC[2]);
        bArr3[3] = aesEnc(bArr3[3], f1278RC[3]);
        bArr3[0] = aesEnc(bArr3[0], f1278RC[4]);
        bArr3[1] = aesEnc(bArr3[1], f1278RC[5]);
        bArr3[2] = aesEnc(bArr3[2], f1278RC[6]);
        bArr3[3] = aesEnc(bArr3[3], f1278RC[7]);
        mix512(bArr3, bArr4);
        bArr3[0] = aesEnc(bArr4[0], f1278RC[8]);
        bArr3[1] = aesEnc(bArr4[1], f1278RC[9]);
        bArr3[2] = aesEnc(bArr4[2], f1278RC[10]);
        bArr3[3] = aesEnc(bArr4[3], f1278RC[11]);
        bArr3[0] = aesEnc(bArr3[0], f1278RC[12]);
        bArr3[1] = aesEnc(bArr3[1], f1278RC[13]);
        bArr3[2] = aesEnc(bArr3[2], f1278RC[14]);
        bArr3[3] = aesEnc(bArr3[3], f1278RC[15]);
        mix512(bArr3, bArr4);
        bArr3[0] = aesEnc(bArr4[0], f1278RC[16]);
        bArr3[1] = aesEnc(bArr4[1], f1278RC[17]);
        bArr3[2] = aesEnc(bArr4[2], f1278RC[18]);
        bArr3[3] = aesEnc(bArr4[3], f1278RC[19]);
        bArr3[0] = aesEnc(bArr3[0], f1278RC[20]);
        bArr3[1] = aesEnc(bArr3[1], f1278RC[21]);
        bArr3[2] = aesEnc(bArr3[2], f1278RC[22]);
        bArr3[3] = aesEnc(bArr3[3], f1278RC[23]);
        mix512(bArr3, bArr4);
        bArr3[0] = aesEnc(bArr4[0], f1278RC[24]);
        bArr3[1] = aesEnc(bArr4[1], f1278RC[25]);
        bArr3[2] = aesEnc(bArr4[2], f1278RC[26]);
        bArr3[3] = aesEnc(bArr4[3], f1278RC[27]);
        bArr3[0] = aesEnc(bArr3[0], f1278RC[28]);
        bArr3[1] = aesEnc(bArr3[1], f1278RC[29]);
        bArr3[2] = aesEnc(bArr3[2], f1278RC[30]);
        bArr3[3] = aesEnc(bArr3[3], f1278RC[31]);
        mix512(bArr3, bArr4);
        bArr3[0] = aesEnc(bArr4[0], f1278RC[32]);
        bArr3[1] = aesEnc(bArr4[1], f1278RC[33]);
        bArr3[2] = aesEnc(bArr4[2], f1278RC[34]);
        bArr3[3] = aesEnc(bArr4[3], f1278RC[35]);
        bArr3[0] = aesEnc(bArr3[0], f1278RC[36]);
        bArr3[1] = aesEnc(bArr3[1], f1278RC[37]);
        bArr3[2] = aesEnc(bArr3[2], f1278RC[38]);
        bArr3[3] = aesEnc(bArr3[3], f1278RC[39]);
        mix512(bArr3, bArr4);
