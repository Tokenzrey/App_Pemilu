        ...
        if (8 % i8 == 0) {
            ...
            while (i16 < i4) {
                ...
                while (i18 < i12) {
                    ...
                    bArr3[i22] = (byte) (bArr3[i22] >>> winternitzOTSVerify.f2172w);
                    i17++;
                    i18++;
                    i14 = i20;
                    i16 = i22;
            ...
            if (i8 < 8) {
                ...
                while (i33 < i28) {
                    ...
                    int i35 = i5;
                    long j2 = 0;
                    while (i35 < winternitzOTSVerify.f2172w) {
                ...
                int i42 = log;
                int i43 = i29;
                int i44 = winternitzOTSVerify.mdsize % winternitzOTSVerify.f2172w;
                int i45 = 0;
                while (i45 < i44) {
                ...
                while (i48 < i47) {
                    ...
                    int i52 = winternitzOTSVerify.f2172w;
                    j >>>= i52;
                    i46++;
                    i48 += i52;
                    i31 = i50;
                }
                int i53 = (i7 << winternitzOTSVerify.f2172w) - i31;
                int i54 = 0;
                while (i54 < i42) {
                    int i55 = winternitzOTSVerify.mdsize;
                    hashSignatureBlock(bArr2, i46 * i55, i43 - (i53 & i43), bArr4, i46 * i55);
                    int i56 = winternitzOTSVerify.f2172w;
                    i53 >>>= i56;
                    i46++;
                    i54 += i56;
                }
                ...
                while (i59 <= i57) {
                    ...
                    int i63 = i59 % 8;
                    int i64 = i57;
                    int i65 = i59 + winternitzOTSVerify.f2172w;
                    int i66 = (i65 + 7) >>> 3;
                    long j3 = 0;
                    int i67 = 0;
                    while (i62 < i66) {
                ...
                int i78 = (i73 << winternitzOTSVerify.f2172w) - i60;
                int i79 = 0;
                while (i79 < log) {
                    ...
                    int i82 = winternitzOTSVerify.f2172w;
                    i78 >>>= i82;
                    i61++;
                    i79 += i82;
                }
