...
public class ComputeInField {
    ...
    /* renamed from: A */
    private short[][] f2227A;

    /* renamed from: x */
    short[] f2228x;

    private void computeZerosAbove() throws RuntimeException {
        for (int length = this.f2227A.length - 1; length > 0; length--) {
            for (int i = length - 1; i >= 0; i--) {
                short[][] sArr = this.f2227A;
    ...
    */
    ...
    private void substitute() throws IllegalStateException {
        short[][] sArr;
        short invElem = GF2Field.invElem(this.f2227A[sArr.length - 1][sArr.length - 1]);
        if (invElem == 0) {
            throw new IllegalStateException("The equation system is not solvable");
        }
        short[] sArr2 = this.f2228x;
        short[][] sArr3 = this.f2227A;
        sArr2[sArr3.length - 1] = GF2Field.multElem(sArr3[sArr3.length - 1][sArr3.length], invElem);
        for (int length = this.f2227A.length - 2; length >= 0; length--) {
            short[][] sArr4 = this.f2227A;
            short s = sArr4[length][sArr4.length];
            for (int length2 = sArr4.length - 1; length2 > length; length2--) {
                s = GF2Field.addElem(s, GF2Field.multElem(this.f2227A[length][length2], this.f2228x[length2]));
            }
            short invElem2 = GF2Field.invElem(this.f2227A[length][length]);
            if (invElem2 == 0) {
                throw new IllegalStateException("Not solvable equation system");
            }
            this.f2228x[length] = GF2Field.multElem(s, invElem2);
        }
    }
    ...
    public short[][] inverse(short[][] sArr) {
        try {
            int i = 0;
            this.f2227A = (short[][]) Array.newInstance(Short.TYPE, sArr.length, sArr.length * 2);
            if (sArr.length != sArr[0].length) {
                throw new RuntimeException("The matrix is not invertible. Please choose another one!");
            }
            for (int i2 = 0; i2 < sArr.length; i2++) {
                for (int i3 = 0; i3 < sArr.length; i3++) {
                    this.f2227A[i2][i3] = sArr[i2][i3];
                }
                for (int length = sArr.length; length < sArr.length * 2; length++) {
                    this.f2227A[i2][length] = 0;
                }
                short[][] sArr2 = this.f2227A;
    ...
    public short[][] multiplyMatrix(short[][] sArr, short[][] sArr2) throws RuntimeException {
        if (sArr[0].length == sArr2.length) {
            this.f2227A = (short[][]) Array.newInstance(Short.TYPE, sArr.length, sArr2[0].length);
            for (int i = 0; i < sArr.length; i++) {
                for (int i2 = 0; i2 < sArr2.length; i2++) {
    ...
    public short[] solveEquation(short[][] sArr, short[] sArr2) {
        ...
        try {
            this.f2227A = (short[][]) Array.newInstance(Short.TYPE, sArr.length, sArr.length + 1);
            this.f2228x = new short[sArr.length];
            for (int i = 0; i < sArr.length; i++) {
                for (int i2 = 0; i2 < sArr[0].length; i2++) {
                    this.f2227A[i][i2] = sArr[i][i2];
                }
            }
            for (int i3 = 0; i3 < sArr2.length; i3++) {
                short[] sArr3 = this.f2227A[i3];
