...
public final class BackgroundProcess {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BackgroundProcess) {
            ...
            return Intrinsics.areEqual(this.f2277id, backgroundProcess.f2277id) && this.startedAt == backgroundProcess.startedAt && Intrinsics.areEqual(this.endedAt, backgroundProcess.endedAt) && Intrinsics.areEqual(this.isSuccess, backgroundProcess.isSuccess) && Intrinsics.areEqual(this.errorMessage, backgroundProcess.errorMessage);
        }
        return false;
    }

    public int hashCode() {
        int hashCode = ((this.f2277id.hashCode() * 31) + Long.hashCode(this.startedAt)) * 31;
        Long l = this.endedAt;
