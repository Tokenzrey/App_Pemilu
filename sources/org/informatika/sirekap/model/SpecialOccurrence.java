...
public final class SpecialOccurrence {
    ...
    public final String pdfUploadSuccessDescription(Context context) {
        ...
        if (this.isUploadedPdfOffline) {
            String string = context.getString(C2644R.string.pdf_uploaded_offline);
            Intrinsics.checkNotNullExpressionValue(string, "{\n            context.ge…loaded_offline)\n        }");
            return string;
        }
        String string2 = context.getString(C2644R.string.pdf_uploaded);
