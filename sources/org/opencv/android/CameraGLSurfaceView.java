...
public class CameraGLSurfaceView extends GLSurfaceView {
    ...
    public CameraGLSurfaceView(Context context, AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, C3061R.styleable.CameraBridgeViewBase);
        int i = obtainStyledAttributes.getInt(C3061R.styleable.CameraBridgeViewBase_camera_id, -1);
