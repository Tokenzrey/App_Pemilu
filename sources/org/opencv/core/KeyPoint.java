...
public class KeyPoint {
    ...
    public String toString() {
        return "KeyPoint [pt=" + this.f2308pt + ", size=" + this.size + ", angle=" + this.angle + ", response=" + this.response + ", octave=" + this.octave + ", class_id=" + this.class_id + "]";
    }
}
