...
public class CameraGLSurfaceView extends GLSurfaceView {
    ...
    public CameraGLSurfaceView(Context context, AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, C3106R.styleable.CameraBridgeViewBase);
        int i = obtainStyledAttributes.getInt(C3106R.styleable.CameraBridgeViewBase_camera_id, -1);
